/*
   File name:   main.cpp
   Purpose:     Main function for the first problem of the WS 2019-20 skills' assessment.
				It serves two purposes. First, it acts as a driver to test the three functions
				calculate_fee(), calculate_parking_time(), and convert_to_coins().
				Second, it implements a parking meter application based on the function bill_customer().
   Authors:     Florian Spieﬂ, Norbert Strobel
   Date:        14.12.2019
   Version:     0.1.0
*/
